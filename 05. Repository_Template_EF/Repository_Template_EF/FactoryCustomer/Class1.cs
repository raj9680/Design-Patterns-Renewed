    ...
    public static class Factory<AnyType>
    {
        ...
        public static AnyType Create(string Type)
        {
            if (ObjectsOfOurProj == null)
            {
                ...
                ObjectsOfOurProj.RegisterType<CustomerBase, Customer>("Customer", new InjectionConstructor(new CustomerValidationAll()));
                ObjectsOfOurProj.RegisterType<CustomerBase, Lead>("Lead", new InjectionConstructor(new LeadValidation()));
